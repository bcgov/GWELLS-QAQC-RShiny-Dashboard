...
helptext_drillers <- function(){
  ...
  is 2016-03-01 to when the data was last updated (this is done nightly). The 'Date Added' and 'Well Tag Number' range selectors do not affect the data displayed in 
  this table."
}