download_data_sql <- function(connection){
...
download_data_csv <- function(){
  message("download wells csv ")
  wells <- readr::read_csv("https://github.com/bcgov/GWELLS-QAQC_Geocode_ArchiveData/raw/main/data/wells.csv")
  
  my_wtn <- wells$well_tag_number
  message("download geocoded csv ")
  geocode <- readr::read_csv("https://github.com/bcgov/GWELLS-QAQC_Geocode_ArchiveData/raw/main/data/wells_geocoded.csv")
  
  
  message("download qa csv")
  qa <- readr::read_csv("https://github.com/bcgov/GWELLS-QAQC_Geocode_ArchiveData/raw/main/data/wells_qa.csv")
...
prepare_all_data <- function(full_data){
  z <- full_data %>%
    dplyr::mutate(
